  ...
  if (session) {
    return <>
      ...
      <div class="max-w-5xl mx-auto py-2 px-4 sm:px-6 lg:px-8">
        <h1 class="text-5xl font-bold text-center mb-8">Du hast alle Präpositionen gemeistert! Mit dem Button kannst du den Übungsfortschritt zurücksetzen oder im Formular neue Übungen erfassen</h1>
