...
export async function getServerSideProps(context) {
  ...
  if (session) {
    ...
    const res2 = await fetch(`http://localhost:3000/api/standing?user=${encodeURIComponent(session.user.email)}&kategorie=deutsch`);
...
export default function Success() {
  ...
  const addDeutsch = async () => {
    if (!newArtikel || !newDefinition || !newPrefix || !newStructure || translations.some((translation) => !translation.Transl_F) ||
        articles.some((article) => !article.TitleOfArticle || !article.Sentence_D || !article.Source || !article.DateSource) ||
        newTypeOfWord.length === 0 || !newWord || !newRoot) {
      ...
      <>
        ...
        <div className="max-w-5xl mx-auto py-2 px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl font-bold text-center mb-8">
            Du hast alle Wortbedeutungen gemeistert! Mit dem Button kannst du den Übungsfortschritt zurücksetzen oder im Formular neue Übungen erfassen
          </h1>
          ...
          <form className="my-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="mb-5">
                  <label htmlFor="word" className="block text-md font-medium text-gray-700">Wort:</label>
                  <input
                    id="word"
                    type="text"
                ...
                <div className="mb-5">
                  <label htmlFor="prefix" className="block text-md font-medium text-gray-700">Präfix:</label>
                  <input
                    id="prefix"
                    type="text"
                ...
                <div className="mb-5">
                  <label htmlFor="root" className="block text-md font-medium text-gray-700">Stamm:</label>
                  <input
                    id="root"
                    type="text"
                ...
                <div className="mb-5">
                  <label htmlFor="structure" className="block text-md font-medium text-gray-700">Struktur:</label>
                  <input
                    id="structure"
                    type="text"
                ...
                <div className="mb-6">
                  <label htmlFor="definition" className="block text-md font-medium text-gray-700">Definition:</label>
                  <input
                    id="definition"
                    type="text"
                ...
                <div className="bg-blue-300 mb-5">
                  {articles.map((article, index) => (
                    <div key={index} className="relative mb-9">
                      <label className="block text-xl font-medium text-gray-700">Beispiel {index + 1}</label>
                      <div>
                        <label htmlFor={`title_${index}`} className="block text-md font-medium text-gray-700">Titel:</label>
                        <input
                          id={`title_${index}`}
                          type="text"
                      ...
                      <div>
                        <label htmlFor={`sentence_${index}`} className="block text-md font-medium text-gray-700">Satz:</label>
                        <input
                          id={`sentence_${index}`}
                          type="text"
                      ...
                      <div>
                        <label htmlFor={`source_${index}`} className="block text-md font-medium text-gray-700">Quelle:</label>
                        <input
                          id={`source_${index}`}
                          type="text"
                      ...
                      <div>
                        <label htmlFor={`date_${index}`} className="block text-md font-medium text-gray-700">Veröffentlichung:</label>
                        <input
                          id={`date_${index}`}
                          type="date"
                      ...
                      {index === 0 && (
                        <button
                          onClick={(e) => { e.preventDefault(); handleAddArticle(); }}
                      ...
                      {index > 0 && (
                        <button
                          onClick={(e) => { e.preventDefault(); handleRemoveArticle(index); }}
              ...
              <div>
                <div className="mb-5">
                  <label htmlFor="artikel" className="block text-md font-medium text-gray-700">Artikel:</label>
                  <div>
                ...
                <div className="mb-5">
                  <label htmlFor="worttyp" className="block text-md font-medium text-gray-700">Wortart:</label>
                  <div>
                ...
                <div className="bg-blue-300 mb-5">
                  <label className="block text-md font-medium text-gray-700">Französische Übersetzungen:</label>
                  {translations.map((translation, index) => (
                    <div key={index} className="relative">
                      {index === 0 && (
                        <button
                          onClick={(e) => { e.preventDefault(); handleAddTranslation(); }}
                      ...
                      {index > 0 && (
                        <button
                          onClick={(e) => { e.preventDefault(); handleRemoveTranslation(index); }}
            ...
            <button
              onClick={(e) => { e.preventDefault(); addDeutsch(); }}
